        ...
        mainPanel(
            ...
            tabsetPanel(type = "pills", 
                        ...
                        tabPanel("Readme", 
                                 ...
                                 p('Then we do processing and prepared 3 tables: most common phrases from our text, containing 2,3 and 4 words. This means that we have collected N-grams, also we know the frequency of these phrases.'),
                                 ...
                                 p('So, we found some N-grams starting with last words of your sentence and now have to choose one. You can set threshold parameter: if it equals to 100 algorythm picks most frequent word, in other case - one random word with frequency greater than X percent.'),
                                 p('It works! Just try to write some words and surprise with prediction'),
